...
- 后端可运行服务（Spring Boot）
  ...
  - 订阅支付：`GET /api/v1/subscription/plans`、`POST /api/v1/subscription/cost-estimate`、`POST /api/v1/orders/create`、`GET /api/v1/orders/history`、`POST /api/v1/refund/apply`
